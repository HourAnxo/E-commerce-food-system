...
// Human-readable label for the backend enum.
...
export default function DeliveryTracking() {
    ...
    // ===== NEW: shared helper — updates one delivery in place after an action =====
    const applyDeliveryUpdate = (updated) => {
        setDeliveriesByOrder((prev) => ({ ...prev, [updated.orderId]: updated }))
    }

    const handleConfirm = async (delivery) => {
        setActingId(delivery.deliveryId)
        setActionError(null)
        try {
                                    ...
                                    <>
                                        ...
                                        {delivery.deliveryStatus === 'Shipped' && delivery.deliveryCode && (
                                            <div className="delivery-code-box">
                                                <p className="muted">
                                                    Give this code to your driver to receive your order:
                                                </p>
                                            ...
                                            <div className="delivery-confirm-box">
                                                ...
                                                <div className="delivery-confirm-actions">
                                                    <button
                                                        ...
                                                        disabled={actingId === delivery.deliveryId}
                                                    >
                                                        {actingId === delivery.deliveryId
                                                            ? 'Please wait…'
                                                            : 'Yes, I received it'}
                                                    </button>
                                                    <button
